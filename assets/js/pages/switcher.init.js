...
function setColor(t){
    document.getElementById("bootstrap-style").href="assets/css/bootstrap-"+t+".min.css",document.getElementById("app-style").href="assets/css/app-"+t+".min.css"
}

function setColorGreen(){
    document.getElementById("bootstrap-style").href="assets/css/bootstrap.min.css",document.getElementById("app-style").href="assets/css/app.min.css"
}
...
btn.addEventListener("click",function(t){
    ...
    var preloader=document.getElementById("preloader");window.addEventListener("load",function(){
    ...
    {var favouriteBtns=favouriteBtn[i];favouriteBtns.onclick=function(){
